...
* **Payload validation**: Create your own validator or use existing validators like Joi or Parambulator.
 **Meatdata**: Transfer metadata across services or attach contextual data to tracing systems.
